            ...
            {showPreview && (
                <div style={{
                    ...
                    {isRunning && acquisitionId && (
                        <img
                            key={sessionKey}
                            src={`${apiBase}/gt-acquisition/preview?acquisitionId=${encodeURIComponent(acquisitionId)}${localStorage.getItem('token') ? `&_stream_auth_token=${encodeURIComponent(localStorage.getItem('token'))}` : ''}`}

...
// Narrowed alongside the server: timetable (ITTC, TTADMIN) and attendance
// (iams-admin, iams-dept-admin) roles are other modules' and no longer carry
// staff powers here. Teaching staff hold FACULTY.
const TEACHER_PLATFORM_ROLES = ['FACULTY'];
const ADMIN_PLATFORM_ROLES = ['admin', 'lm-admin'];

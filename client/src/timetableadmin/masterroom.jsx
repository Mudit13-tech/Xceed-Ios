      ...
      <Container maxW="7xl" mt={-12} position="relative" zIndex={1} pb={{ base: 10, md: 16 }} px={{ base: 4, md: 6, lg: 8 }}>
        <VStack spacing={6} align="stretch">
          ...
          <Card
            ...
            overflow="hidden"
          >
            <CardHeader bgGradient="linear(to-r, teal.400, cyan.400)" color="white" p={{ base: 3, md: 4 }}>
              <Heading size={{ base: "sm", md: "md" }}>Batch Upload</Heading>
            </CardHeader>
          ...
          <Card
            ...
            overflow="hidden"
          >
            <CardHeader bgGradient="linear(to-r, green.400, teal.400)" color="white" p={{ base: 3, md: 4 }}>
          ...
          <Card
            ...
            overflow="hidden"
          >
            <CardHeader bgGradient="linear(to-r, emerald.400, green.400)" color="white" p={{ base: 3, md: 4 }}>
              <Heading size={{ base: "sm", md: "md" }}>
